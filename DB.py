...
class JDItem(Base):
    ...
    item_status = Column(Boolean, nullable=False)
    max_shown_price = Column(FLOAT)
    min_shown_price = Column(FLOAT)
    shown_price = Column(FLOAT)
    max_estimate_price = Column(FLOAT)
    min_estimate_price = Column(FLOAT)
    estimate_price = Column(FLOAT)
    first_add_time = Column(DateTime)
